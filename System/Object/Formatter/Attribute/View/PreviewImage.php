...
{
    protected $persistentAttributes = array('enableLinking','selectedOption','backgroundColor','width','height');
    ...
    {
        $img = $this->getContent()->getPreviewImage()->scaled(
            $this->width, 
            $this->height, 
        ...
        return parent::toXHTML(strval($img)."\n");
    }
}
?>