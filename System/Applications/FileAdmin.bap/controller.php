...
if(isset($_FILES['bambus_file']['name']) && PAuthorisation::has('org.bambuscms.download.file.create')){ 
...
if(RSent::get('action') == 'delete' && PAuthorisation::has('org.bambuscms.downlaad.file.delete'))
{
