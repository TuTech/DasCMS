 ...
 * @subpackage Widget
 */
class View_UIElement_FlowLayout extends _View_UIElement 
{
    private $id;
    //display 
    private $title = null;
    ...
    public function render()
    {
        ...
        printf("<div class=\"View_UIElement_FlowLayout\" id=\"View_UIElement_FlowLayout_%s\">\n", $this->id);
        foreach ($this->data as $item) 
        {
        	printf("\t<div class=\"View_UIElement_FlowLayoutItem %s\">\n\t\t", $this->cssClasses);
        	if($item instanceof _View_UIElement)
        	{
        	    $item->render();
        	}
        	else
        ...
        print("\t<br class=\"View_UIElement_FlowLayoutEnd\" />\n</div>\n");
    }
    /**
